...
func (fs *FSComN5) ListVlanMappings() ([]models.VlanMapping, error) {
...
func (fs *FSComN5) ConfigureVlanMapping(mapping *models.VlanMapping) (bool, error) {
	commands := []string{
		"configure terminal",
	}
...
func (fs *FSComN5) DeleteVLANMapping(name string) {
	//TODO implement me
	panic("implement me")
}
